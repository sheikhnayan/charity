                            ...
                            <div class="row gy-3 ">
                                <div class="col-lg-3 d-flex align-items-center">
                                    ...
                                    <div class="rounded-profile-picture border border-3 border-primary mx-auto" style="border-radius: 50%; border-color: #2e4053 !important">
                                        <img src="{{ asset($student->photo) }}" style="border-radius: 50%; width: 70px; min-width: 70px; height: 70px; min-height: 70px;" onerror="this.src='{{ asset('uploads/'.$check->setting->logo) ?? asset('images/default-logo.png') }}';">
                                    </div>
                                </div>
